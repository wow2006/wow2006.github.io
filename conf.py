...
BLOG_AUTHOR = "Ahmed Abdel Aal"  # (translatable)
BLOG_TITLE = "Salt and Pepper"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wow2006.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://wow2006.github.io/"
BLOG_EMAIL = "eng.ahmedhussein89@gmail.com"
BLOG_DESCRIPTION = "An other Computer Graphics and Vision blog."  # (translatable)
